document.addEventListener('DOMContentLoaded', function(){
    ...
    btnReset.addEventListener('click', function(e){
        e.preventDefault();
        limpiarTodasAlertas(e.target.parentElement.parentElement);// Para quitar todas las alertas
        resetFormulario();
    });
   ...
   function validarEmail(email){
    ...
    function limpiarTodasAlertas(referencia) {
        const alerta = referencia.querySelectorAll('.bg-red-600');
        alerta.forEach(elementos => elementos.remove());
    }
});